...
- Name: lab.spec.ts >> Chongoyape Bizcochuelos Lab — full functional validation >> recipe lab: clicking a diagnostic variant updates the detail panel
- Location: tests/lab.spec.ts:138:7
