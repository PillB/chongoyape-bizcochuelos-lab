...
- Name: lab.spec.ts >> Chongoyape Bizcochuelos Lab — full functional validation >> glossary floating button: opens glossary dialog
- Location: tests/lab.spec.ts:242:7
...
Call log:
  - waiting for locator('button[aria-label="Open glossary"]')
    - locator resolved to <button type="button" data-state="closed" title="Open glossary" aria-expanded="false" aria-haspopup="dialog" aria-label="Open glossary" data-slot="dialog-trigger" aria-controls="radix-_r_5_" class="fixed bottom-5 left-5 z-50 h-11 w-11 rounded-full bg-card border border-border shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center text-primary group">…</button>
