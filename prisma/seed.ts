...
async function main() {
  ...
  const claims = [
    ...
    { category: 'ingredient', statement: 'The recipe contains vanilla or citrus zest.', confidence: 'contradicted', evidenceBasis: 'Master thesis (studocu.com) with direct grandson interview lists Valera ingredients as: harina, azúcar rubia, azúcar blanca, huevos, polvo de hornear, chuño, leche de vaca. Vanilla/vainilla is NOT listed. Downgraded from weak to contradicted — the primary source ingredient list does not include any flavoring extract or zest.', counterTest: 'A producer statement that vanilla IS used, or a sensory test detecting vanillin.', status: 'downgraded' },
